                            ...
                            @foreach($groups as $orderNumber => $group)
                                ...
                                <tr class="hover:bg-gray-50 align-top cursor-pointer"
                                    ...
                                    <td class="px-4 py-3 text-center"
                                        ...
                                        @if($draftSent)
                                            <span class="text-[10px] font-medium text-green-600 whitespace-nowrap" title="A HelpScout draft reply has been created and is awaiting send">Draft ready</span>
                                        @else
                                            <span class="text-[10px] text-gray-400 whitespace-nowrap">No draft</span>
                                        @endif
