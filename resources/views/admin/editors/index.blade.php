<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Editors</h2>
        ...
        <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @if ($editors->isEmpty())
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center text-gray-500">
                    No editors yet. <a href="{{ route('admin.editors.create') }}" class="text-indigo-600 hover:underline">Add one.</a>
                </div>
            @else
                        ...
                        <tbody class="bg-white divide-y divide-gray-100">
                            @foreach ($editors as $editor)
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-3 text-gray-500">{{ $editor->email }}</td>
