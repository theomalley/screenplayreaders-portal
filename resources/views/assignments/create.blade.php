        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-5 items-start"
                ...
                <div class="space-y-5 min-w-0">
                    ...
                    <form id="create-form" method="POST" action="{{ route('assignments.store') }}" enctype="multipart/form-data">
                        @csrf
                                ...
                                @foreach ($readers as $reader)
                                    <label class="flex items-center gap-2 cursor-pointer select-none text-sm text-gray-700">
                                        <input type="checkbox" name="blocked_reader_ids[]" value="{{ $reader->id }}"
                                            {{ in_array((string) $reader->id, (array) old('blocked_reader_ids', []), true) ? 'checked' : '' }}
                                            class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500 focus:ring-offset-0" />
                                        {{ $reader->readerProfile?->initials ?? $reader->name }}
                                    </label>
                                @endforeach
                ...
                <div class="space-y-5 order-first lg:order-none lg:sticky lg:top-5">
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                        <div class="flex items-center gap-2">
                            <x-primary-button form="create-form" class="flex-1 justify-center">Create Assignment</x-primary-button>
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-5 space-y-4">
                        ...
                        <div>
                            ...
                            <select id="status" name="status" form="create-form"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-sm">
                        ...
                        <div x-show="numReaders === '1'">
                            ...
                            <select id="assigned_reader_id" name="assigned_reader_id" form="create-form"
                                :disabled="numReaders !== '1'"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-sm">
                                <option value="">None</option>
                        ...
                        <div>
                            ...
                            <input type="text" id="helpscout_ticket_number" name="helpscout_ticket_number" form="create-form"
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-5 space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div>
                                ...
                                <input type="date" id="date" name="date" form="create-form"
                            ...
                            <div>
                                ...
                                <input type="time" id="time" name="time" form="create-form"
                        ...
                        <div class="pt-3 border-t border-gray-100">
                            <div class="flex items-center gap-3">
                                <input type="hidden" name="create_invoice" form="create-form" value="0">
                                <input type="checkbox" id="create_invoice" name="create_invoice" form="create-form" value="1"
                            ...
                            <div x-show="createInvoice" x-cloak class="mt-3 space-y-3">
                                <div>
                                    ...
                                    <select id="invoice_client_id" name="invoice_client_id" form="create-form"
                                ...
                                <div>
                                    ...
                                    <div class="mt-1 relative">
                                        ...
                                        <x-text-input id="invoice_amount" name="invoice_amount" form="create-form" type="number"
                                            step="0.01" min="0.01"
