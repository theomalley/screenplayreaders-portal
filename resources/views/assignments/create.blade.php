                ...
                <form method="POST" action="{{ route('assignments.store') }}" class="p-6 space-y-5"
                    ...
                    <div class="grid grid-cols-2 gap-3 items-start">
                        ...
                        <div>
                            ...
                            @php $initVendor = old('vendor', 'sr'); @endphp
                            <select id="assignment_type" x-ref="typeSelect" name="assignment_type"
                                ...
                                @if($initVendor === 'sr')
                                    ...
                                    <option value="notes_only"       {{ old('assignment_type') === 'notes_only'       ? 'selected' : '' }}>Notes-Only Coverage</option>
                                    ...
                                    <option value="budget"           {{ old('assignment_type') === 'budget'           ? 'selected' : '' }}>Budget Script Coverage</option>
